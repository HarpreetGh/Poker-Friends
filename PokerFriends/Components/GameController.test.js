...
test('isRoyalFlush() given the player hand is NOT a royal flush', () => {
  expect(isRoyalFlush([{suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}], 0)).toBeFalsy();
});
...
test('isStraightFlush() given the player hand is NOT a straight flush', () => {
  expect(isStraightFlush([{suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}], 0)).toBeFalsy();
});

test('isStraightFlush() given the player hand is a straight flush', () => {
  expect(isStraightFlush([{suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}], 0)).toBeTruthy();
});

// 3
test('isFourOfKind() given the player hand is NOT a is a four of a kind', () => {
  expect(isFourOfKind([{suit:'spade', value:'2'}, {suit:'heart', value:'2'}, {suit:'diamond', value:'2'}, {suit:'club', value:'2'}, {suit:'', value:'4'}, {suit:'diamond', value:'5'}, {suit:'spade', value:'A'}], 0)).toBeFalsy();
});

test('isFourOfKind() given the player hand is a four of a kind', () => {
  expect(isFourOfKind([{suit:'spade', value:'2'}, {suit:'heart', value:'2'}, {suit:'diamond', value:'2'}, {suit:'club', value:'2'}, {suit:'', value:'4'}, {suit:'diamond', value:'5'}, {suit:'spade', value:'A'}], 0)).toBeTruthy();
});

// 4
test('isFullHouse() given the player hand is NOT a full house', () => {
  expect(isFullHouse([{suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}], 0)).toBeFalsy();
});

test('isFullHouse() given the player hand is a full house', () => {
  expect(isFullHouse([{suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}], 0)).toBeTruthy();
});

// 5
test('isFlush() given the player hand is NOT a flush', () => {
  expect(isFlush([{suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}], 0)).toBeFalsy();
});

test('isFlush() given the player hand is a flush', () => {
  expect(isFlush([{suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}], 0)).toBeTruthy();
});

// 6
test('isStraight() given the player hand is NOT a straight', () => {
  expect(isStraight([{suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}], 0)).toBeFalsy();
});

test('isStraight() given the player hand is a straight', () => {
  expect(isStraight([{suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}, {suit:'', value:''}], 0)).toBeTruthy();
});
